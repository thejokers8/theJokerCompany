...
<div className="about-company-container flex flex-col ">
        ...
        <div className="about-company-plan flex justify-between">
            <div className="about-mision p-9">
                ...
                <p className="mision text-sm border-r-2 border-gray-900 pr-6 text-justify">
            ...
            <div className="about-vision p-9">
                <h2 className="title text-green-500 mb-3 text-xl font-extrabold uppercase tracking-wider text-justify "> Vision</h2>
