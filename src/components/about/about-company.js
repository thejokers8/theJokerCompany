...
<div className="about-company-container  flex flex-col ">
        ...
        <div className="about-company-plan flex justify-between">
            <div className="about-mision p-9">
                <h2 className="title text-center text-green-500 mb-3 text-xl font-extrabold uppercase tracking-wider"> Mission</h2>
                <p className="mision text-sm text-justify">
            ...
            <div className="about-vision p-9">
                <h2 className="title text-center text-green-500 mb-3 text-xl font-extrabold uppercase tracking-wider "> Vision</h2>
                <p className="vision-text text-sm text-justify">
