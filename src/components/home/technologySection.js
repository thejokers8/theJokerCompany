...
function TechnologySection(){
    return(
        <div className="px-10 sm:px-32 mt-[-2.5em]">
            ...
            <p className="mb-20 mx-10 lg:mx-32 text-[1.1rem] sm:text-[1.3rem] text-[rgba(0,0,0,0.8)]">
            ...
            <div className="flex flex-col md:flex-row bg-[rgba(0,118,61,0.5)] pt-12 pb-5 px-10 justify-around rounded-[0.5em] lg:mx-32 mt-[-1.5em] mb-10">
                <p className="language text-white mb-5 mx-2 text-[1.1rem] sm:text-[1.25rem] shadow-xl py-[0.2em] px-[1em] rounded-[0.5em] bg-[rgba(0, 118, 61, 0)] border-4 border-[rgba(255,255,255,0.5)] hover:scale-110 duration-500">
                    Python
                </p>
                <p className="language text-white mb-5 mx-2 text-[1.1rem] sm:text-[1.25rem] shadow-xl py-[0.2em] px-[1em] rounded-[0.5em] bg-[rgba(0, 118, 61, 0)] border-4 border-[rgba(255,255,255,0.5)] hover:scale-110 duration-500">
                    HTML
            ...
            <div className="flex lg:h-[25vh] border-2 border-[#003016] flex-col lg:flex-row justify-around items-center mb-10">
                <div className="web lg:border-r-4 py-10 px-2 lg:w-[40%] border-[#003016]">
                    <p className="text-[1.5rem] sm:[text-[2rem]] font-bold text-[rgba(0,118,61,0.6)] animate-pulse py-5">
                        Web Development
                    </p>
                </div>
                <div className="web-frameworks flex flex-col lg:flex-row justify-around lg:w-[65%] w-full mx-2 ">
                    <p className="lg:ml-[-3em] mb-5 text-[1.1rem] sm:[text-[1.5rem]] font-semibold text-[rgba(0,0,0,0.4)]">
                        ReactJs
                    </p>
                    <p className="text-[1.1rem] sm:[text-[1.5rem]] mb-5 font-semibold text-[rgba(0,0,0,0.4)]">
                        Tailwind
                    </p>
                    <p className="text-[1.1rem] sm:[text-[1.5rem]] mb-5 font-semibold text-[rgba(0,0,0,0.4)]">
                        Boostrap
            ...
            <div className="flex lg:h-[25vh] border-2 border-[#003016] lg:flex-row flex-col justify-around items-center">
                ...
                <div className="my-2 lg:w-[65%] flex flex-wrap justify-center items-center">
                    <p className="text-[1.1rem] sm:[text-[1.5rem]] mx-16 py-5 font-semibold text-[rgba(0,0,0,0.4)]">
                        TensorFlow
                    </p>
                    <p className="text-[1.1rem] sm:[text-[1.5rem]] mx-16 py-5 font-semibold text-[rgba(0,0,0,0.4)]">
                        Sckitlearn
